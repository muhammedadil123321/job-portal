              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className={`w-full px-4 py-2.5 rounded-md font-medium flex items-center ${
                      formData.jobStatus === 'active' 
                        ? 'bg-green-50 border border-green-300 text-green-700'
                        : 'bg-red-50 border border-red-300 text-red-700'
                    }`}>
                      <CheckCircle className="w-5 h-5 mr-2" />
                      {formData.jobStatus === 'active' ? 'Active' : 'Closed'}
                    </div>
                  </div>
                </div>
                    ...
                    <div className="w-full h-80 bg-gray-100 rounded-md overflow-hidden border border-gray-300">
                      <iframe
                        src={`https://maps.google.com/maps?q=${encodeURIComponent(
                          formData.workplaceAddress + ", " + formData.city + ", " + formData.state + ", " + formData.country
                        )}&output=embed`}
                        width="100%"
                        height="100%"
                        style={{ border: 0 }}
